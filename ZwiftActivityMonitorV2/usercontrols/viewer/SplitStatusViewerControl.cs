    ...
    public partial class SplitStatusViewerControl : StatusViewerControlEx
    {
        ...
        public void CreateDocumentText()
        {
            ...
            */
            ...
            string splitStatus = Properties.Resources.SplitStatus;
            string delta = "";
            ...
            splitStatus = splitStatus.Replace("SplitTime", this.mSplitEventArgs.SplitTime.ToString());
            ...
            splitStatus = splitStatus.Replace("TotalTime", this.mSplitEventArgs.TotalTime.ToString());
